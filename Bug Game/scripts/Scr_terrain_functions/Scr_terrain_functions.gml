...
_terrain_checked = false;
	...
	///ground
	if !collision_point(x, y, Obj_water, true, true)&& _terrain_checked = false|| !collision_point(x, y, Obj_poison, true, true)&& _terrain_checked = false|| !collision_point(x, y, Obj_glass, true, true) &&_terrain_checked = false{
	_terrain_checked = true;
